...
namespace DrivingSchoolApi.Features.AccessManagment.SystemAdmin.RolePermission
{
    ...
    #region Handlers
    public class ListRolePermissionsHandler(DrivingSchoolDbContext db) : IRequestHandler<ListRolePermissionsQuery, List<RolePermissionDto>>
    {
    ...
    public class GetRolePermissionHandler(DrivingSchoolDbContext db) : IRequestHandler<GetRolePermissionQuery, AspRolePermissions>
    {
    ...
    public class CreateRolePermissionHandler(DrivingSchoolDbContext db, ICurrentUserService userService) : IRequestHandler<CreateRolePermissionCommand, bool>
    {
    ...
    public class DeleteRolePermissionHandler(DrivingSchoolDbContext db) : IRequestHandler<DeleteRolePermissionCommand, bool>
    {
    ...
    public class UpdateRolePermissionsHandler(DrivingSchoolDbContext db, ICurrentUserService userService) : IRequestHandler<UpdateRolePermissionsCommand, bool>
    {
