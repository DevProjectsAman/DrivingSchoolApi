...
namespace DrivingSchoolApi.Features.AccessManagment.SystemAdmin.RolePermission
{
    ...
    // --- Get All ---
    public class GetAllPermissionsHandler(DrivingSchoolDbContext db) : IRequestHandler<GetAllPermissionsQuery, ResponseResultDTO<List<AspPermission>>>
    {
    ...
    // --- Get One ---
    public class GetPermissionByIdHandler(DrivingSchoolDbContext db) : IRequestHandler<GetPermissionByIdQuery, ResponseResultDTO<AspPermission>>
    {
    ...
    // --- Create ---
    public class CreatePermissionHandler(DrivingSchoolDbContext db, ICurrentUserService userService)
    ...
    // --- Update ---
    public class UpdatePermissionHandler(DrivingSchoolDbContext db, ICurrentUserService userService)
    ...
    // --- Delete ---
    public class DeletePermissionHandler(DrivingSchoolDbContext db)
